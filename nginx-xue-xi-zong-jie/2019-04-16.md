...
![&#x7ADE;&#x4E89;&#x9501;&#x7684;&#x8FC7;&#x7A0B;](../.gitbook/assets/image%20%2840%29.png)
...
3. handler模块对请求进行处理，响应结果发送给过滤模块；
4. 一系列过滤模块依次对响应结果进行处理；
5. 过滤模块处理完之后，将响应结果返回给客户端。

![&#x6A21;&#x5757;&#x5904;&#x7406;&#x8BF7;&#x6C42;&#x7684;&#x6D41;&#x7A0B;](../.gitbook/assets/image.png)
...
2. 处理请求行，解析请求行；
3. 处理请求头，解析请求头；
4. 处理请求，调用所有content phase handlers或content handler；
5. 生成响应结果。
